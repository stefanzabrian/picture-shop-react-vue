          ...
          <div class="flex items-center">
            ...
            <div class="flex-shrink-0 w-24">
              ...
              <button
                ...
                class="rounded-md bg-amber-500 mt-2 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-amber-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600"
              >
                View
              </button>
            </div>
